...
public class  BookingControllerTest {
    ...
    public void getAllBookingsByUserTest() throws Exception {
        when(bookingService.getAllBookingByUserId(1L, State.ALL, 0, 1)).thenReturn(List.of(bookingResponseDto));
    ...
    public void getAllBookingsByOwnerTest() throws Exception {
        ...
        when(bookingService.getAllBookingsByOwner(2L, State.ALL, 0, 1)).thenReturn(List.of(bookingResponseDto));
